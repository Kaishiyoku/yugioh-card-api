...
if (!function_exists('fetchIsLimited')) {
    /**
     * @param \Symfony\Component\DomCrawler\Crawler $crawler
     * @param \Symfony\Component\CssSelector\CssSelectorConverter $converter
     * @return bool
     */
    function fetchIsLimited(\Symfony\Component\DomCrawler\Crawler $crawler, \Symfony\Component\CssSelector\CssSelectorConverter $converter)
    {
